...
import (
	"kuentra-official/metamorphosis/meta_accelerator_vector"
	"kuentra-official/metamorphosis/meta_accelerator_vector/functions"
	"slices"
	"unsafe"
...
func Info() meta_accelerator_vector.SystemInfo {
	return meta_accelerator_vector.Info()
}

// SetAcceleration toggles simd acceleration. Not thread safe.
func SetAcceleration(enabled bool) {
	meta_accelerator_vector.SetAcceleration(enabled)
}
