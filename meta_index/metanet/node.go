...
import (
	...
	"kuentra-official/metamorphosis/metamorphose/dimstore"
	"sync"
	"sync/atomic"
)
...
type graphNode struct {
	...
	neighbours    []dimstore.VectorStorePoint
...
func (g *graphNode) LoadNeighbours(vstore dimstore.VectorStore) error {
...
func (g *graphNode) AddNeighbour(neighbour dimstore.VectorStorePoint) int {
...
func (g *graphNode) AddNeighbourIfNotExists(neighbour dimstore.VectorStorePoint) int {
...
func (g *graphNode) ReadFrom(id uint64, bucket v1disk.Bucket) (node *graphNode, err error) {
...
func (g *graphNode) WriteTo(id uint64, bucket v1disk.Bucket) error {
...
func (g *graphNode) DeleteFrom(id uint64, bucket v1disk.Bucket) error {
...
func (v *IndexMetaNet) EdgeScan(deleteSet map[uint64]struct{}) (toPrune, toSave []uint64, err error) {
	// ---------------------------
