...
func (iv *IndexMetaNet) pruneDeleteNeighbour(pointA dimstore.VectorStorePoint, nodeA *graphNode, deleteSet map[uint64]struct{}) error {
	// ---------------------------
...
func (v *IndexMetaNet) removeInboundEdges(deleteSet map[uint64]struct{}) error {
