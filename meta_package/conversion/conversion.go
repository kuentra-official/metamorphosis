 ...
 * of the main bottle necks of a disk based vector database like metamorphosis is
 ...
 * mind. Another thing to consider is that, it is unlikely that metamorphosis will be
 ...
 * metamorphosis is run in a cluster of heterogeneous machines.
 *
